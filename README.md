...
This repository contains slides and demo files for the talk on Vagrant.

To use it, you will need to have a functioning Vagrant environment with
VirtualBox and Ansible.

Set the environment variable `VAGRANT_BOX_REPOSITORY_URL` that points to
your Vagrant box as a `file:///` or `http:///` URL.

The RevealJS slides are part of the demo. RevealJS README follows:
